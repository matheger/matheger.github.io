...
{:.center-image}
![KNIME workflow for full raw data upload](/assets/images/bikeshare/Full Raw Upload KNIME Workflow.png){: height="80%" width="80%"}  
*The KNIME workflow for full raw data upload*
