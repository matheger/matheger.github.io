...
{:.center-image}
![KNIME workflow for full upload of raw data](/assets/1_project/Full Raw Upload KNIME Workflow.png){: height="50%" width="50%"}](/assets/1_project/Full Raw Upload KNIME Workflow.png)  
